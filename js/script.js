    ...
    $.ajax({
        ...
        success : function( data, textStats, XMLHttpRequest ) {
            ...
            $.each( aBusinesses, function( index, oBusiness ) {
                ...
                sOptions += "<div class='col-md-6'><div class='panel panel-default'><div class='panel-heading' style='background-color:black; color:white;'><h4>" 
...
// hides "GO Again" button when clicked and shows "GO" button
